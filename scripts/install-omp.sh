...
# -- Atomic writes. --
# mcp.json and RULES.md are the user's real config and may hold unrelated
...
time. Search returns questions only, so open relevant threads to read the
answers. Treat answers as leads and verify them against the current system.
