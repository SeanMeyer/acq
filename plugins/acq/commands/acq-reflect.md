...
2. Identify new Q&A candidates. The bar is whether it would save the next
...
3. Search for duplicates before proposing a new question.
4. Present each candidate with its title, body, answer, and tags. Ask the user
   which candidates to save or revise.
5. Submit selected new questions with `ask`, then attach their answers. Use
...
6. Report what was saved, skipped, voted on, or corrected.
