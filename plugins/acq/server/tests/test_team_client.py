...
class TestSearch:
    ...
    async def test_returns_none_on_connection_error(self, client: TeamClient, monkeypatch: pytest.MonkeyPatch) -> None:
        monkeypatch.setattr(client._client, "get", _raise_connect_error)
        result = await client.search("query")
        assert result is None

    async def test_returns_none_on_http_error(self, client: TeamClient, monkeypatch: pytest.MonkeyPatch) -> None:
...
class TestCreateQuestion:
    ...
    async def test_returns_error_dict_on_http_error(self, client: TeamClient, monkeypatch: pytest.MonkeyPatch) -> None:
        monkeypatch.setattr(
            client._client,
            "post",
...
class TestCreateAnswer:
    ...
    async def test_returns_error_dict_on_404(self, client: TeamClient, monkeypatch: pytest.MonkeyPatch) -> None:
