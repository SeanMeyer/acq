...
Thank you for your interest in contributing to acq. This guide explains how to get involved.

## Types of Contribution

There are two distinct types of contribution to this project, each with its own governance:

- **Code contributions** to the acq software (source code, tests, documentation, tooling). These are governed by the [Apache 2.0 license](LICENSE) and the standard open-source practices described in this file.
- **Knowledge unit contributions** to the shared commons (structured agent learnings submitted through acq itself). These are governed by the [Contributor Agreement](CONTRIBUTOR_AGREEMENT.md), which covers licensing, provenance, and quality expectations specific to knowledge contributions.
...
- **Search for duplicates.** Check [existing issues](https://github.com/SeanMeyer/acq/issues) and [open pull requests](https://github.com/SeanMeyer/acq/pulls) before starting work.
...
2. Add the upstream remote: `git remote add upstream https://github.com/SeanMeyer/acq.git`
...
This project is maintained by one person, so review times are best-effort
...
- Look for issues labeled [`good-first-issue`](https://github.com/SeanMeyer/acq/labels/good-first-issue) or [`help-wanted`](https://github.com/SeanMeyer/acq/labels/help-wanted).
...
This project follows the [Contributor Covenant](https://www.contributor-covenant.org/version/2/1/code_of_conduct/). Please treat all participants with respect.
